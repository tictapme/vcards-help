...
La sección de **Tarjetas** en el menú lateral izquierdo es donde podrás ver, editar y gestionar todas las tarjetas de tu equipo.  Para editar los datos de una tarjeta, como por ejemplo **cambiar el cargo** o un **número de móvil**, sigue los siguientes pasos:
