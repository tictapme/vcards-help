# Edit the text fields of a vcard

The **Cards** section in the left sidebar menu is where you can view, edit, and manage all your team's cards. To edit card details, such as **changing the position** or a **mobile number**, follow these steps:

1. Locate the name of the person you want from the **card list** <br> <br> 
...
3. In the dropdown menu on the right-hand side, click on **Edit** <br> <br>
...
4. Now you can modify any field on the card, and when you click **Save**, it will be updated on the corresponding vcard <br> <br>
